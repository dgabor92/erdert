...
function EditVagonModal({ vagon, onSave, onCancel }) {
  const [editedVagon, setEditedVagon] = useState(vagon);

  const handleSaveClick = () => {
    for (const key in editedVagon) {
      if (editedVagon[key] === "" || editedVagon[key] === null) {
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                      <input
                        ...
                        name="belepes_datuma"
                        id="belepes_datuma"
                        value={editedVagon.belepes_datuma}
                        onChange={(e) =>
                          setEditedVagon({
                            ...editedVagon,
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                      <input
                        ...
                        name="kilepes_datuma"
                        id="kilepes_datuma"
                        value={editedVagon.kilepes_datuma}
                        onChange={(e) =>
                          setEditedVagon({
                            ...editedVagon,
