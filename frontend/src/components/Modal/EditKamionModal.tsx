...
function EditKamionModal({ kamion, onSave, onCancel }) {
  const [editedKamion, setEditedKamion] = useState(kamion);

  const handleSaveClick = () => {
    for (const key in editedKamion) {
      if (editedKamion[key] === "" || editedKamion[key] === null) {
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                      <input
                        ...
                        id="szal_level_szama"
                        value={editedKamion.szal_level_szama}
                        onChange={(e) =>
                          setEditedKamion({
                            ...editedKamion,
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                      <input
                        ...
                        name="belepes_datuma"
                        id="belepes_datuma"
                        value={editedKamion.belepes_datuma}
                        onChange={(e) =>
                          setEditedKamion({
                            ...editedKamion,
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                      <input
                        ...
                        name="kilepes_datuma"
                        id="kilepes_datuma"
                        value={editedKamion.kilepes_datuma}
                        onChange={(e) =>
                          setEditedKamion({
                            ...editedKamion,
...
export default EditKamionModal;
