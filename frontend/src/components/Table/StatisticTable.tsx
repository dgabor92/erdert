...
function StatisticTable({ kamions, teherautos, szemelyautos, vagons }) {
  ...
  const renderTable = () => {
    switch (selectedCategory) {
      case 1:
        return <KamionTable kamions={kamions} stat={stat} />;
      case 2:
        return <TeherATable teherautos={teherautos} stat={stat} />;
      case 3:
        return <SzemelyATable szemelyautos={szemelyautos} stat={stat} />;
      case 4:
        return <VagonTable vagons={vagons} stat={stat} />;
      default:
        return null;
    }
  };
